...
* insert TSVariableDynamic("id", "example", "[resource.id]", "Enter a known resource id on the destination system.")
...
* insert TSTestOperationResource(#read, #{resource}, {return_type}, 1, 1, "ResourceRead", "/${id}")
